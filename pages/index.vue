...
<template>
  ...
  <!-- Hero Section -->
      <section class="flex items-center justify-between h-[100vh] pt-[10vh] gap-4 bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800">
         ...
         <NuxtImg src="/hero.webp" class="h-[450px] object-cover" />
      </section>
      <!-- Tab Section -->
      <section>
          ...
          <div class="bg-blue-500 dark:bg-blue-800 p-8">
             ...
             <div v-for="(item, index) in templates" :key="index">
                   <div class="flex flex-col mt-4">
                    <div class="bg-gray-500 dark:bg-gray-800 flex items-center gap-5">
                        <div class="flex justify-center items-center bg-blue-500/30 dark:bg-blue-800/30 p-3 h-20">
                          <NuxtImg :src="item.image" class="w-12 h-full" />
                        </div>
